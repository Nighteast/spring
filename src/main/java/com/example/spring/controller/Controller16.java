...
public class Controller16 {
    ...
    public String method6() {
        ...
        // redirection
        // 다른 곳(location)으로 가라는 응답(response, 302)
    ...
    // 첫 요청을 /main15/sub14로 보냈을 때
    @GetMapping("sub14")
    public String method14(String foodList, RedirectAttributes rttr) {
        // /main16/sub15요청할 때
        // foodList라는 attribute를 넣어서 꺼낼 수 있게
        // 코드작성
        rttr.addFlashAttribute("foodList", foodList);
    ...
    public String method16(RedirectAttributes rttr) {
        ...
        rttr.addAttribute("attr1", "쿼리스트림에 붙음");
